# -*- coding: utf-8 -*-
"""
Created on Fri Dec  4 00:57:59 2020
...
model.summary()
model.load_weights('F:\CS416\Project\models\dialogue_system/bert_weights_4.h5')
...
def check_similarity(sentence1, sentence2):
    ...
    proba = model.predict(test_data)[0]*100
    idx = np.argmax(proba)
    proba =proba[idx]
    pred = labels[idx]
